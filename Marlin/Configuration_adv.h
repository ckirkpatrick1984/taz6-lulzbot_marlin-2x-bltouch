 ...
 */
  ...
  #define ADAPTIVE_FAN_SLOWING LULZBOT_ADAPTIVE_FAN_SLOWING // Slow part cooling fan if temperature
...
//#define CODEPENDENT_XY_HOMING
  ...
  #define BLTOUCH_FORCE_SW_MODE LULZBOT_BLTOUCH_FORCE_SW_MODE
...
#define STATUS_MESSAGE_SCROLLING LULZBOT_STATUS_MESSAGE_SCROLLING
...
//#define LED_CONTROL_MENU
  ...
  #define USB_FLASH_DRIVE_SUPPORT LULZBOT_USB_FLASH_DRIVE_SUPPORT
    ...
    #define USB_INTR_PIN       LULZBOT_USB_INTR_PIN
  #endif
...
#define BABYSTEPPING LULZBOT_BABYSTEPPING
  ...
  #define BABYSTEP_XY LULZBOT_BABYSTEP_XY   // Also enable X/Y Babystepping. Not supported on DELTA!
...
#define MIN_STEPS_PER_SEGMENT LULZBOT_MIN_STEPS_PER_SEGMENT
 ...
 */
  ...
  #define TOOLCHANGE_ZRAISE LULZBOT_TOOLCHANGE_ZRAISE // (mm)
 ...
 */
  ...
  #define INTERPOLATE       true  // Interpolate X/Y/Z_MICROSTEPS to 256
  ...
  #if AXIS_IS_TMC(X)
    #define X_CURRENT    LULZBOT_X_CURRENT // (mA) RMS current. Multiply by 1.414 for peak current.
    #define X_MICROSTEPS   16  // 0..256
    #define X_RSENSE     LULZBOT_R_SENSE
  #endif
    ...
    #define Y_MICROSTEPS   16
    #define Y_RSENSE     LULZBOT_R_SENSE
  #endif
    ...
    #define Z_RSENSE     LULZBOT_R_SENSE
  #endif
    ...
    #define E0_MICROSTEPS  16
    #define E0_RSENSE    LULZBOT_R_SENSE
  #endif

  #if AXIS_IS_TMC(E1)
    #define E1_CURRENT   LULZBOT_E1_CURRENT
    #define E1_MICROSTEPS  16
    #define E1_RSENSE    LULZBOT_R_SENSE
  #endif
   ...
   */
  #define SENSORLESS_HOMING LULZBOT_SENSORLESS_HOMING // StallGuard capable drivers only
 ...
 */
#define HOST_ACTION_COMMANDS LULZBOT_HOST_ACTION_COMMANDS
